...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM keterangan_gaji WHERE no = '$id'";
...
if (isset($_POST['submit'])) {
    ...
    $updateQuery = "UPDATE keterangan_gaji SET keterangan = '$keterangan', debitkredit = '$debitkredit' WHERE no = '$id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Keterangan Gaji</title>
...
<div class="container-fluid">
    <h3 class="text-center mb-4">Edit Keterangan Gaji</h3>
    <div class="row mt-4">
        <div class="col-md-8">
            <div class="card p-4">
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="mb-3 text-start">
                            ...
                            <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?php echo isset($row) ? $row['keterangan'] : ''; ?>" required>
                        </div>
                        <div class="mb-3 text-start">
                            <label for="debitkredit" class="form-label">Debit/Kredit</label>
                            <input type="text" class="form-control" id="debitkredit" name="debitkredit" value="<?php echo isset($row) ? $row['debitkredit'] : ''; ?>" required>
                        </div>
