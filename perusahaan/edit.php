...
// Ambil ID perusahaan dari parameter
if (!isset($_GET['id'])) {
    echo "<script>alert('ID perusahaan tidak ditemukan'); window.location.href='index.php';</script>";
    exit();
}
...
<!-- Form Edit -->
<div class="container-fluid">
    <h3 class="text-center mb-4">Edit Data Perusahaan</h3>
    <div class="row mt-4">
        <div class="col-md-8">
            <div class="card p-4">
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="2" required><?php echo $data['alamat']; ?></textarea>
                        </div>
                        <div class="mb-3 text-start">
